...
deblock_h_chroma_422_shuf:      times 8 db 0
                                times 8 db 1
                                times 8 db 2
                                times 8 db 3
...
INIT_YMM avx2
cglobal deblock_h_chroma_422, 0, 0
%if WIN64
    mov            r4, [rsp + 40]
    vmovdqu        [rsp + 8], xm6
    vmovdqu        [rsp + 24], xm7
...
%endif
    vpbroadcastd   m0, [r4]
    vpshufb        m0, m0, [deblock_h_chroma_422_shuf]  ; tc0 tc1 tc2 tc3

    ; load and transpose
    lea            r5, [r1 + r1 * 2]   ; 3 * stride
    lea            r4, [r0 - 2]        ; using in store
    sub            r0, 4
    lea            r6, [r0 + r1 * 8]
    vmovq          xm1, [r0]
    vinserti128    m1, m1, [r6], 1
    vmovq          xm2, [r0 + r1]
    vinserti128    m2, m2, [r6 + r1], 1
    vpunpcklwd     m1, m1, m2          ; row0 row1(p1) row0 row1(p0) row0 row1(q0) row0 row1(q1) | row8 row9...
    vmovq          xm2, [r0 + r1 * 2]
    vinserti128    m2, m2, [r6 + r1 * 2], 1
    vmovq          xm3, [r0 + r5]
    vinserti128    m3, m3, [r6 + r5], 1
    vpunpcklwd     m2, m2, m3          ; row2 row3(p1) row2 row3(p0) row2 row3(q0) row2 row3(q1) | row10 row11...

    lea            r0, [r0 + r1 * 4]
    lea            r6, [r6 + r1 * 4]
    vmovq          xm3, [r0]
    vinserti128    m3, m3, [r6], 1
    vmovq          xm4, [r0 + r1]
    vinserti128    m4, m4, [r6 + r1], 1
    vpunpcklwd     m3, m3, m4          ; row4 row5(p1) row4 row5(p0) row4 row5(q0) row4 row5(q1) | row12 row13...
    vmovq          xm4, [r0 + r1 * 2]
    vinserti128    m4, m4, [r6 + r1 * 2], 1
    vmovq          xm5, [r0 + r5]
    vinserti128    m5, m5, [r6 + r5], 1
    vpunpcklwd     m4, m4, m5          ; row6 row7(p1) row6 row7(p0) row6 row7(q0) row6 row7(q1) | row14 row15...

    vpunpckldq     m5, m1, m2          ; row0 row1 row2 row3(p1) row0 row1 row2 row3(p0) | row8 row9 row10 row11...
    vpunpckhdq     m6, m1, m2          ; row0 row1 row2 row3(q0) row0 row1 row2 row3(q1) | row8 row9 row10 row11...
    vpunpckldq     m7, m3, m4          ; row4 row5 row6 row7(p1) row4 row5 row6 row7(p0) | row12 row13 row14 row15...
    vpunpckhdq     m8, m3, m4          ; row4 row5 row6 row7(q0) row4 row5 row6 row7(q1) | row12 row13 row14 row15...

    vpunpcklqdq    m1, m5, m7          ; row0 row1 row2 row3 row4 row5 row6 row7(p1) | row8 -- row15
    vpunpckhqdq    m2, m5, m7          ; row0 row1 row2 row3 row4 row5 row6 row7(p0) | row8 -- row15
    vpunpcklqdq    m3, m6, m8          ; row0 row1 row2 row3 row4 row5 row6 row7(q0) | row8 -- row15
    vpunpckhqdq    m4, m6, m8          ; row0 row1 row2 row3 row4 row5 row6 row7(q1) | row8 -- row15
    ...
    ; shuffle and save
    vpunpcklwd     m0, m2, m3          ; row0 row1 row2 row3 | row8 row9 row10 row11
    vpunpckhwd     m1, m2, m3          ; row4 row5 row6 row7 | row12 row13 row14 row15
    lea            r6, [r4 + r1 * 4]
    vmovd          [r4], xm0
    vpextrd        [r4 + r1], xm0, 1
    vpextrd        [r4 + r1 * 2], xm0, 2
    vpextrd        [r4 + r5], xm0, 3
    vmovd          [r6], xm1
    vpextrd        [r6 + r1], xm1, 1
    vpextrd        [r6 + r1 * 2], xm1, 2
    vpextrd        [r6 + r5], xm1, 3
    lea            r4, [r4 + r1 * 8]
    lea            r6, [r6 + r1 * 8]
    ...
    vmovd          [r4], xm2
    vpextrd        [r4 + r1], xm2, 1
    vpextrd        [r4 + r1 * 2], xm2, 2
    vpextrd        [r4 + r5], xm2, 3
    vmovd          [r6], xm3
    vpextrd        [r6 + r1], xm3, 1
    vpextrd        [r6 + r1 * 2], xm3, 2
    vpextrd        [r6 + r5], xm3, 3
...
INIT_YMM avx2
cglobal deblock_h_chroma_422_intra, 0, 0
%if WIN64
    vmovdqu        [rsp + 8], xm6
    vmovdqu        [rsp + 24], xm7
    sub            rsp, 24
...
%endif
    ...
    vpunpcklqdq    m2, m5, m7          ; row0 row1 row2 row3 row4 row5 row6 row7(p1) | row8 -- row15
    vpunpckhqdq    m3, m5, m7          ; row0 row1 row2 row3 row4 row5 row6 row7(p0) | row8 -- row15
    vpunpcklqdq    m4, m6, m8          ; row0 row1 row2 row3 row4 row5 row6 row7(q0) | row8 -- row15
    vpunpckhqdq    m5, m6, m8          ; row0 row1 row2 row3 row4 row5 row6 row7(q1) | row8 -- row15

    vmovd          xm0, r2d
    vmovd          xm1, r3d
    vpbroadcastb   m0, xm0              ; alpha
    vpbroadcastb   m1, xm1              ; beta
    vpbroadcastd   m6, [pb_1]
    ; alpha and beta must > 0, so we can safely -1
    vpsubb         m0, m0, m6          ; alpha - 1
    vpsubb         m1, m1, m6          ; beta - 1
    ...
    ; shuffle and save
    vpunpcklwd     m0, m3, m4          ; row0 row1 row2 row3 | row8 row9 row10 row11
    vpunpckhwd     m1, m3, m4          ; row4 row5 row6 row7 | row12 row13 row14 row15
    lea            r6, [r4 + r1 * 4]
    vmovd          [r4], xm0
    vpextrd        [r4 + r1], xm0, 1
    vpextrd        [r4 + r1 * 2], xm0, 2
