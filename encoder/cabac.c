...
{
    h->bsf.cabac_block_residual_internal( l, ctx_block_cat, cb );
}
...
{
    h->bsf.cabac_block_residual_8x8_rd_internal( l, ctx_block_cat, cb );
}
static ALWAYS_INLINE void cabac_block_residual( x264_t *h, x264_cabac_t *cb, int ctx_block_cat, dctcoef *l )
{
    h->bsf.cabac_block_residual_rd_internal( l, ctx_block_cat, cb );
}
#endif
